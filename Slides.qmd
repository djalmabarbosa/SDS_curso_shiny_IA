...
## Positron: A Nova Geração

::::: columns
::: {.column width="50%"}
**Positron (novo IDE da Posit)**

-   Interface moderna e rápida
-   Suporte nativo a R e Python
-   Editor de dados avançado
-   Console aprimorado
-   Integração com IA
-   Código aberto
:::
...
-   Se busca interface moderna
-   Trabalha com R e Python
-   Quer recursos de última geração
-   Prefere performance otimizada
...
## Outras Opções: VS Code

::::: columns
::: {.column width="50%"}
**Visual Studio Code + R**

-   Editor leve e moderno
-   Extensões: R, R LSP
-   Terminal integrado
-   Git nativo
-   Comunidade ativa
...
-   Se já usa VS Code
-   Trabalha com múltiplas linguagens
-   Prefere interface minimalista
-   Projetos de desenvolvimento web
:::
:::::

::: callout-note
Para iniciantes, RStudio ainda é mais recomendado!
:::

## Outras Opções: Posit Cloud

::::: columns
::: {.column width="50%"}
**Posit Cloud (RStudio na nuvem)**

-   Sem instalação necessária
-   Acesso via navegador
-   Colaboração facilitada
-   Recursos limitados (plano free)
-   Ideal para ensino
:::
...
# 2. Fundamentos Básicos do R {background-color="#2C3E50"}
...
# 3. Manipulação de Dados {background-color="#2C3E50"}
...
# 4. Visualização de Dados {background-color="#2C3E50"}
...
# 5. Programação Básica {background-color="#2C3E50"}
...
# 6. Funções no R {background-color="#2C3E50"}
...
#| echo: true
#| eval: false
nome <- function(arg1, arg2 = valor_padrao) {
  # corpo da função
  return(resultado)
}
```
...
# Por nome
funcao(arg1 = valor1, arg2 = valor2)

# Misto
funcao(valor1, arg2 = valor2)
```

**Lembre-se:**

-   Argumentos por posição: ordem importa
-   Argumentos por nome: ordem não importa
-   Valores padrão são opcionais
...
# 7. Shiny - Fundamentos {background-color="#2C3E50"}
...
-   Drill-down em dados detalhados
:::
...
::: incremental
-   **Saúde:** dashboards hospitalares, calculadoras clínicas, monitoramento de pacientes
-   **Negócios:** análise de vendas, previsão de demanda, CRM interativo
-   **Educação:** notas interativas, análise de desempenho, material didático
-   **Ciência:** análise de experimentos, visualização de dados, publicações interativas
-   **Governo:** transparência de dados públicos, indicadores sociais, mapas de serviços
-   **Finanças:** análise de investimentos, risco de crédito, planejamento financeiro
:::

## Vantagens do Shiny

::: {.callout-tip}
## Por que escolher Shiny?

**✅ Sem necessidade de conhecer web development**

**✅ Totalmente em R - use suas habilidades existentes**
...
**Mas para a maioria dos casos de análise de dados e visualização interativa, Shiny é perfeito!**
...
# 8. Reatividade no Shiny {background-color="#2C3E50"}
...
# 9. IA e Prompting para R/Shiny {background-color="#2C3E50"}
...
# 11. Boas Práticas {background-color="#2C3E50"}
...
3.  **Desenvolva iterativamente** com ajuda de IA
    -   Tive essa ideia para um R shiny app: ... Vc acha viável?
    -   Me ajude a estabelecer as característics
4.  **Documente seu código**
5.  **Teste com sua família ou colegas**
6.  **Publique** (não obrigatório) (shinyapps.io, GitHub)
:::

# Desenvolva iterativamente com ajuda de IA {.scrollable}
...
Os arquivos desta apresentação estão disponíveis em: https://github.com/djalmabarbosa/SDS_curso_shiny_IA
